...
@Component
public class JavaCodeNode extends AbstractLanguageCodeNode {

    public JavaCodeNode(AiModelRegistry aiModelRegistry,
    ...
    protected String resolveExecutionRulesPrompt() {
        return PromptHelper.buildJavaCodeExecutionRulesPrompt();
    }
}
