...
@Component
public class PythonCodeNode extends AbstractLanguageCodeNode {

    public PythonCodeNode(AiModelRegistry aiModelRegistry,
    ...
    protected String resolveExecutionRulesPrompt() {
        return PromptHelper.buildPythonCodeExecutionRulesPrompt();
    }
}
